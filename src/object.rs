...
impl Object {
  pub fn load_obj(render_state: &egui_wgpu::RenderState, path: &Option<&std::path::Path>) -> (eframe::wgpu::Buffer, u32) {
    ...
    let vertex_buffer = render_state.device.create_buffer_init(&eframe::wgpu::util::BufferInitDescriptor {
        label: None,
